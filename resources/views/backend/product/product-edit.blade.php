                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_name_ind" class="form-control"
                                                        required="" value="{{ $products->product_name_ind }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_ind" class="form-control"
                                                        value="{{ $products->product_tags_ind }}" data-role="tagsinput"
                                                        required="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_ind" class="form-control"
                                                        value="{{ $products->product_size_ind }}" data-role="tagsinput">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_color_ind" class="form-control"
                                                        value="{{ $products->product_color_ind }}" data-role="tagsinput">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_ind" id="textarea" class="form-control"
                                                        required placeholder="Textarea text">
